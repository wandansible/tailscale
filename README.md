...
ENTRY POINT: *main* - Install and configure tailscale
          ...
          Install, configure and authenticate a tailscale client with
          a tailscale network.
...
- tailscale_config  Tailscale configuration file options
          default: {}
          type: dict
          options:
...
- tailscale_config_dir  Directory for tailscale configuration
...
- tailscale_packages  List of packages to install
          default: [tailscale]
          elements: str
          type: list

- tailscale_serve  Tailscale serve configuration
          default: null
          elements: dict
          type: list
          options:
          ...
          = to  The local target to serve onto the tailscale network.
                 ...
                 directory listing with links to files and
                 sub-directories.
                 Static text server Specifying text:<value> configures
                 a simple static plain-text server.
                 Reverse proxy The location to the local service can
                 be expressed as a port number (for example, 3000), a
                 partial URL (for example, localhost:3000), or a full
                 URL including a path ( for example,
...
- tailscale_version  Version of tailscale to install
